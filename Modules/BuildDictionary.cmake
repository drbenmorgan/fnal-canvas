...
# That's a UPSism and then NOT clear where HAVE_ROOT6/5 need to be defined.
# Assume ROOT6 for now as that's what canvas relies on
set(HAVE_ROOT6 1)
#if( NOT ROOT_VERSION )
...
function(_generate_dictionary dictname)
  ...
  if(HAVE_ROOT6)
    list(APPEND GENREFLEX_FLAGS
      -l ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}${dictname}_dict${CMAKE_SHARED_LIBRARY_SUFFIX}
      )
  endif()
  ...
  if(BD_WANT_PCM)
    set(PCM_OUTPUT ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/${CMAKE_SHARED_LIBRARY_PREFIX}${dictname}_dict_rdict.pcm)
...
function(build_dictionary)
  ...
  if(BD_UNPARSED_ARGUMENTS)
    ...
    if(BD_USE_PRODUCT_NAME)
      set(dictname ${PROJECT_NAME}_${dictname})
    endif()
  endif()
  ...
  if(BD_WANT_ROOTMAP AND NOT ROOT6_HAS_NOINCLUDEPATH)
    # Header line and OS X lib name fixing only necessary for older ROOT6 (so which one?).
